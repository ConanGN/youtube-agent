...
import { YouTubeVideo, EditHistory, UnifiedDataItem, DynamicColumnConfig, COLUMN_TEMPLATES } from '@/types'
...
export function YouTubeTable({
  ...
  }, [isMounted, data, dynamicColumns.columnConfigs.length, dynamicColumns.addColumn])
